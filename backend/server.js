...
// Middleware
app.use(cors({
    origin: ['http://localhost:3000','https://demak-ventures.vercel.app', 'https://joyful-monstera-9c1133.netlify.app', 'https://demak-ventures.netlify.app', 'http://localhost:5173', 'https://demakgh.com', 'http://demakgh.com'],
    credentials: true,
