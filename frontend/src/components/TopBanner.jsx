      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-20">
        <div className="flex items-center justify-between py-2.5 text-sm">
          ...
          <div className="flex items-center text-gray-600">
            ...
            <span className="font-medium text-xs sm:text-sm whitespace-nowrap">+233 24 408 6787</span>
          </div>
          ...
          <div className="flex items-center text-gray-600">
            ...
            <span className="font-medium text-xs sm:text-sm whitespace-nowrap">info@Demakshop.com</span>
          </div>
        </div>
